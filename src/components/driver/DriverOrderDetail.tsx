  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-card p-4 shadow-sm">
        ...
        {customer?.phone && (
          <div className="mt-1">
            <p dir="ltr" className="text-sm font-bold text-brand">{customer.phone}</p>
            <div className="mt-1.5 flex gap-2">
              <a
                href={`tel:${customer.phone}`}
                className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-brand px-3 py-2 text-sm font-bold text-brand-foreground"
              >
              ...
              <a
                ...
                className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-[#25D366] px-3 py-2 text-sm font-bold text-white"
              >
