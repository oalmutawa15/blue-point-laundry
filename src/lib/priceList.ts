...
export const PRICE_CATEGORIES: PriceCategory[] = [
  {
    ...
    items: [
      ...
      { key: "socks", en: "Socks", ar: "جوارب", prices: p(250, 250, null) },
      { key: "underwear", en: "Underwear", ar: "ملابس داخلية", prices: p(250, 250, 200) },
      { key: "undershirt", en: "Undershirt", ar: "فانلة داخلية", prices: p(300, 300, 200) },
      { key: "trouser", en: "Trouser", ar: "بنطلون", prices: p(600, 750, 300) },
      { key: "long_jacket", en: "Long Jacket", ar: "جاكيت طويل", prices: p(2000, 3000, 1500) },
      { key: "sweater_cardigan", en: "Sweater / Cardigan", ar: "كنزة / كارديجان", prices: p(1000, 1250, 500) },
      { key: "mukasar", en: "Mukasar", ar: "مكسّر", prices: p(300, 300, 200) },
    ],
  },
  {
    key: "women",
    ...
    items: [
      ...
      { key: "abaya_special", en: "Abaya Special", ar: "عباية خاصة", prices: p(3000, 3000, 1500) },
      { key: "daraa_special_1", en: "Daraa Special 1", ar: "دراعة خاصة ١", prices: p(2500, 2500, 1500) },
      { key: "pleated_skirt", en: "Pleated Skirt", ar: "تنورة بليسيه", prices: p(1500, 1500, 1000) },
      { key: "pleated_trouser", en: "Pleated Trouser / Pant", ar: "بنطلون بليسيه", prices: p(1500, 1500, 1000) },
      { key: "evening_dress", en: "Evening Dress", ar: "فستان سهرة", prices: p(6000, 6000, 2500) },
      { key: "long_blouse", en: "Long Blouse", ar: "بلوزة طويلة", prices: p(1000, 1250, 750) },
    ],
  },
  {
    key: "children",
  ...
  },
  {
    ...
    items: [
      ...
      { key: "sheet_double", en: "Bed Sheet (Double)", ar: "شرشف (مزدوج)", prices: p(1000, 1000, 500), image: "/items/sheet_double.jpg" },
      ...
      { key: "sofa_cover_medium", en: "Sofa Cover (Medium)", ar: "غطاء كنبة (وسط)", prices: p(3000, 3000, null) },
      { key: "sofa_cover_small", en: "Sofa Cover (Small)", ar: "غطاء كنبة (صغير)", prices: p(2000, 2000, null) },
      { key: "curtains", en: "Curtains (per m²)", ar: "ستائر (بالمتر المربع)", prices: p(1000, 1000, null) },
      { key: "carpet", en: "Carpet (per m²)", ar: "سجاد (بالمتر المربع)", prices: p(1000, null, null) },
    ],
  },
  {
    key: "cleaning",
